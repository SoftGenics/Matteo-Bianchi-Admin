    ...
    const updateProduct = async (event) => {
        ...
        try {
            ...
            const payload = {
                ...
                pattern_type: editData.pattern_type || '',
                ...
                <div className="popup-overlay" onClick={closePopup}>
                    <div className="popup-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="popup-details">
                            ...
                            <p><strong>Size:</strong> {popupProduct.size_type || 'N/A'}</p>
                            <p><strong>Pattern:</strong> {popupProduct.pattern_type || 'N/A'}</p>
                            <p><strong>Closure:</strong> {popupProduct.closure_type || 'N/A'}</p>
                    ...
                    <div className="unique-overlay" onClick={closeEditPopup}>
                        <div className="unique-container" onClick={(e) => e.stopPropagation()}>
                            ...
                            <form className="unique-form" onSubmit={updateProduct}>
                                ...
                                <div className="unique-form-group">
                                    <label htmlFor="size_type" className="unique-label">Size_Type:</label>
                                    <input
                                        type="text"
                                        id="size_type"
                                        name="size_type"
                                        value={editData.size_type || ''}
                                        onChange={handleInputChange}
                                        className="unique-input"
                                    />
                                </div>
                                ...
                                <div className="unique-form-group">
                                    <label htmlFor="closure_type" className="unique-label">Closure_Type:</label>
                                    <input
                                        type="text"
                                        id="closure_type"
                                        name="closure_type"
                                        value={editData.closure_type || ''}
                                        onChange={handleInputChange}
                                        className="unique-input"
                                    />
                                </div>
